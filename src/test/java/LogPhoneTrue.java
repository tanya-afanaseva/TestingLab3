...
public class LogPhoneTrue {
  ...
  @Test
  public void testLog_phone_true() throws Exception {
    ...
    Thread.sleep(5000);
    driver.findElement(By.xpath("//html/body/div[1]/div[1]/div[2]/div/div/div[1]/div/div[1]/form/div[1]/input")).sendKeys("+79214383731");
