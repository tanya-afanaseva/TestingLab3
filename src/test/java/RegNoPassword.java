...
public class RegNoPassword {
	...
	@Test
	public void testReg_no_password() throws Exception {
		driver.findElement(By.xpath("//html/body/div[3]/div[2]/div/div[2]/div/form/div[3]/input")).sendKeys("tanygggogaaf03.11@gmail.com");
		driver.findElement(By.xpath("//html/body/div[3]/div[2]/div/div[2]/div/form/div[4]/input")).clear();
